...
//        twitter = new TwitterFactory(builder.build()).getInstance(accessToken);
        ...
        try {
            ...
            RecyclerView recyclerView = (RecyclerView)findViewById(R.id.tweet_list_recycler_view);
            ...
            Toast.makeText(getApplicationContext(), "妹有网络获取不到首页推特哦(⊙o⊙)？", Toast.LENGTH_LONG).show();
        }
    }
